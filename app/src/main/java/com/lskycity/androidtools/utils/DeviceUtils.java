...
public final class DeviceUtils {
    ...
    private static final String PANASONIC_DEVICE_PREFIX = "FZ";
    ...
    public static boolean isChromeBookDevice() {
        return Build.MODEL.toLowerCase().contains("chromebook")
                || (Build.BRAND.equals("chromium") && Build.MANUFACTURER.equals("chromium"));
        ...
        //but it's not true, in chromebook pixel and acer r11, both Build.BRAND and Build.MANUFACTURER are google
    }

    public static boolean isPanasonicDevice() {
        String model = Build.MODEL;
        return model.startsWith(PANASONIC_DEVICE_PREFIX);
    }
